  ...
  table = $('#datatable').DataTable( {
    ...
    columnDefs: [{
      ...
      render: function (data, type, row, meta) {
        ...
        <a class="btn btn-sm btn-icon btn-secondary" data-row='${dataRow}' data-toggle="modal" href="#modalFormDelete" data-tabela="dev_modulos" data-campo="ativo" data-valor="Não" data-datatable="datatable"><i class="far fa-trash-alt"></i></a>
