      ...
      <form class="auth-form" action="<?= $_SERVER['PHP_SELF'] ?>" method="POST">
        ...
        <div class="form-group">
          <div class="form-label-group">
            <input name="email" value="<?= getPost('email') ?>" type="email" id="inputEmail" class="form-control" placeholder="Email" required="" autofocus=""> <label for="inputEmail">Email</label>
          </div>
        </div><!-- /.form-group -->
        <!-- .form-group -->
        <div class="form-group">
          <div class="form-label-group">
            <input name="nome" value="<?= getPost('nome') ?>" type="text" id="inputUser" class="form-control" placeholder="Nome" required=""> <label for="inputUser">Nome</label>
          </div>
        </div><!-- /.form-group -->
        <!-- .form-group -->
        <div class="form-group">
        ...
        <!-- recovery links 
        <p class="text-center text-muted mb-0"> By creating an account you agree to the <a href="#">Terms of Use</a> and <a href="#">Privacy Policy</a>. </p>
        !-- /recovery links -->
      </form><!-- /.auth-form -->
      <!-- copyright -->
      <footer class="auth-footer"> © 2022 All Rights Reserved. </footer>
    </main><!-- /.auth -->