...
const load = (e) => {
  table = $('#datatable').DataTable( {
    ajax: base_url + '/planoprecos/get/'+id,
    responsive: true,
    ...
    columnDefs: [{
      ...
      render: function (data, type, row, meta) {
        ...
        <a class="btn btn-sm btn-icon btn-secondary" data-row='${dataRow}' data-toggle="modal" href="#modalFormDelete" data-tabela="dev_plano_precos" data-campo="ativo" data-valor="Não" data-datatable="datatable"><i class="far fa-trash-alt"></i></a>
        `
      }
    }]
  } );
  ...
  $('#modalForm').on('show.bs.modal', function (event) {
    ...
    if (row !== undefined){
      ...
      document.getElementById('preco').value = row.preco
    }
  })
